...
public partial class PostFXStack
{
    ...
    public void Setup(ScriptableRenderContext context, Camera camera, PostFXSettings settings, bool useHDR, int colorResolution)
    {
    ...
    public void Render(int sourceId)
    {
        ...
        if (DoBloom(sourceId))
        {
            DoColorGradingAddToneMapping(bloomResultId);
            buffer.ReleaseTemporaryRT(bloomResultId);
        }
        else
        {
            DoColorGradingAddToneMapping(sourceId);
        }
