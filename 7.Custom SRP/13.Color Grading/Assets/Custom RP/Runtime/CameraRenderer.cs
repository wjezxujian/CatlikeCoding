...
public partial class CameraRenderer
{
    ...
    public void Render(ScriptableRenderContext context, Camera camera, bool allowHDR, bool useDynamicBatching,
        bool useGPUInstancing, bool useLightsPerObject, ShadowSettings shadowSettings, PostFXSettings postFXSettings, int colorResolution)
    {
        ...
        postFXStack.Setup(context, camera, postFXSettings, useHDR, colorResolution);
