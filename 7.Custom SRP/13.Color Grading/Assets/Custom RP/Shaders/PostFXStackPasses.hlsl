...
float3 ColorGradingShadowsMidtonesHighlights(float3 color, bool useACES)
{
    ...
    float midtonesWeidht = 1.0 - shadowsWeight - highlightsWeight;
    return color * _SMHShadows.rgb * shadowsWeight + color * _SMHMidtones.rgb * midtonesWeidht + color * _SMHHighlights.rgb * highlightsWeight;
}
