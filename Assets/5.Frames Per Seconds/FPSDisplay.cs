...
{
    public Text highestFPSLabel, averageFPSLable, lowestFPSLable;
    ...
    private void Update()
    {
        ...
        //averageFPSLable.text = stringsFrom00To99[Mathf.Clamp(fpsCounter.AverageFPS, 0, 99)];
        //lowestFPSLable.text = stringsFrom00To99[Mathf.Clamp(fpsCounter.LowestFPS, 0, 99)];

        Display(highestFPSLabel, fpsCounter.HighestFPS);
        Display(averageFPSLable, fpsCounter.AverageFPS);
        Display(lowestFPSLable, fpsCounter.LowestFPS);
    }
